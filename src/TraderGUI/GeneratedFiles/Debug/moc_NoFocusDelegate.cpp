...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_NoFocusDelegate_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_NoFocusDelegate_t qt_meta_stringdata_NoFocusDelegate = {
    {
QT_MOC_LITERAL(0, 0, 15) // "NoFocusDelegate"
...
const QMetaObject NoFocusDelegate::staticMetaObject = {
    { &QStyledItemDelegate::staticMetaObject, qt_meta_stringdata_NoFocusDelegate.data,
      qt_meta_data_NoFocusDelegate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *NoFocusDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NoFocusDelegate.stringdata0))
