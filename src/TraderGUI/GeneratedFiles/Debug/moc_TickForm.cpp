...
QT_MOC_LITERAL(1, 9, 27), // "pushButtonSendOrder_clicked"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 23), // "tableWidget_cellClicked"
QT_MOC_LITERAL(4, 62, 3), // "row"
QT_MOC_LITERAL(5, 66, 6), // "column"
QT_MOC_LITERAL(6, 73, 30) // "contractlineedit_returnPressed"

    },
    "TickForm\0pushButtonSendOrder_clicked\0"
    "\0tableWidget_cellClicked\0row\0column\0"
    "contractlineedit_returnPressed"
};
...
void TickForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pushButtonSendOrder_clicked(); break;
        case 1: _t->tableWidget_cellClicked((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->contractlineedit_returnPressed(); break;
        default: ;
        }
    }
}
